...
echo " blob(s) necessary for duma hardware" >> $target_owner/staging/device-partial.mk
...
then
echo "    vendor/$target_owner/duma/proprietary/$(basename $file):$file:$target_owner \\" >> $target_owner/staging/device-partial.mk
fi
